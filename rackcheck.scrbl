...
@deftogether[(
  ...
  @racket[shrink-tree?] returns @racket[#t] when @racket[v] is a
  @tech{shrink tree} and @racket[make-shrink-tree] creates a new shrink-tree from
  @racket[init-v], and procedure for shrinking it.
}
